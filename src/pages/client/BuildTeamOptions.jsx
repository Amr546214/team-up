...
const BuildTeamOptions = () => {
  ...
  const publishedJob =
    location.state?.job ||
    location.state?.publishedJob ||
    location.state?.selectedJob ||
    null;

  console.log("BUILD OPTIONS location.state:", location.state);
  console.log("BUILD OPTIONS publishedJob:", publishedJob);
  ...
  const options = [
    ...
    },
    {
      title: "Build with AI",
      description:
        "Let TeamUp AI help you choose the best team members based on your project needs.",
    ...
    },
    {
      ...
      description:
        "Let the system suggest a complete ready team for your project automatically.",
